...
class Topmenu
{
    ...
    */
    ...
    {
        $swappartyUrl = $topmenu->getUrl('grid/index/index');//here you can set link
        ...
        $html .= "<a href=\"" . $swappartyUrl . "\" class=\"level-top ui-corner-all\"><span class=\"ui-menu-icon ui-icon ui-icon-carat-1-e\"></span><span>" . __("News") . "</span></a>";
        $html .= "</li>";
        return $html;
    }
}